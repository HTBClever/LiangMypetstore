...
<table>
	...
	<tr>
		<td>
			<c:if test="${sessionScope.account==null}"><a class="Button" href="viewSignOn">Add to Cart</a></c:if>
			<c:if test="${sessionScope.account!=null}"><a class="Button" href="addItemToCart?workingItemId=${sessionScope.item.itemId}">Add to Cart</a></c:if>
		</td>
	</tr>
</table>
